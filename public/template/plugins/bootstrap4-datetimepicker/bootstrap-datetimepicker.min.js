    ...
    var n = function (n, a) {
        var r,
                        ...
                        e("<tr>")
                            .append(
                                e("<th>")
                                    ...
                                    .append(
                                        e("<span>").addClass(a.icons.previous)
                                    )
                            )
                            .append(
                                e("<th>")
            ...
            Q = function () {
                ...
                for (
                    ...
                    (e = s.year() + 12),
                        (p =
                            a.minDate &&
                            a.minDate.isAfter(s, "y") &&
                            a.minDate.year() <= e),
                        (c =
                            a.maxDate &&
                            a.maxDate.isAfter(s, "y") &&
                            a.maxDate.year() <= e),
                        (u +=
            ...
            _ = function (e) {
                ...
                if (
                    ...
                    for (
                        e
                            .minutes(
                                Math.round(e.minutes() / a.stepping) *
                                    a.stepping
                            )
                            .seconds(0);
            ...
            ae = {
                ...
                selectMonth: function (t) {
                    ...
                    i.month(n),
                        p === h
                            ? (_(r.clone().year(i.year()).month(i.month())),
                              a.inline || ee())
                            : (j(-1), U()),
                        B("M");
                },
            ...
            re = function (t) {
                return (
                    ...
                    (ae[e(t.currentTarget).data("action")].apply(c, arguments),
                    !1)
                );
            },
            ie = function () {
            ...
            fe = function () {
                ...
                (d = e.replace(
                    ...
                    (l = a.extraFormats ? a.extraFormats.slice() : []).indexOf(
                        e
                    ) < 0 &&
                        l.indexOf(d) < 0 &&
                        l.push(d),
        ...
        if (
            ...
            (c.enabledDates = function (t) {
                if (0 === arguments.length)
                    return a.enabledDates
                        ? e.extend({}, a.enabledDates)
                        : a.enabledDates;
            ...
            (c.viewMode = function (e) {
                ...
                return (
                    (a.viewMode = e), (p = Math.max(w.indexOf(e), h)), j(), c
                );
            }),
                ...
                (function () {
                    ...
                    return (
                        (t =
                            n.is("input") || a.inline
                                ? n.data()
                                : n.find("input").data()).dateOptions &&
                            t.dateOptions instanceof Object &&
                            (r = e.extend(!0, r, t.dateOptions)),
                        e.each(a, function (e) {
                            var n =
                                "date" + e.charAt(0).toUpperCase() + e.slice(1);
                            void 0 !== t[n] && (r[e] = t[n]);
                        }),
                        r
                    );
