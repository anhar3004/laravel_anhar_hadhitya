    ...
    e.locale("en"),
        (t.fn[i] = function (e, i) {
            return (
                this.each(function () {
                    t.data(this, a)
                        ? ("function" == typeof t.data(this, a)[e] &&
                              t.data(this, a)[e](i),
        ...
        (s.prototype = {
            ...
            initTemplate: function () {
                for (
                    var e = "", i = this.currentDate.year(), a = i - 3;
                    a < i + 4;
                    a++
                )
                    e +=
            ...
            initHours: function () {
                ...
                for (var e = this.createSVGClock(!0), i = 0; i < 12; i++) {
                    ...
                    ((h = this.createSVGElement("text", {
                        ...
                        0 === i && this.params.shortTime ? 12 : i),
                        this.toggleTime(i, !0)
                            ? (d.addEventListener(
                                  "click",
            ...
            _onYearItemClick: function (e) {
                var i =
                    t(e.currentTarget).data("year") - this.currentDate.year();
