    ...
    var a = function (a, i, s) {
        ...
        if (
            ...
            "string" == typeof i.cancelClass &&
                (this.cancelClass = i.cancelClass),
    ...
    return (
        (a.prototype = {
            ...
            renderCalendar: function (a) {
                ...
                if (this.showDropdowns) {
                    ...
                    _ += "</select>";
                    for (
                        var E = '<select class="yearselect">', W = L;
                        W <= I;
                        W++
                    )
                        E +=
                ...
                (Y += "</tbody>"),
                    (Y += "</table>"),
                    this.container
                        .find(".calendar." + a + " .calendar-table")
                        .html(Y);
            },
        ...
        (e.fn.daterangepicker = function (t, i) {
            return (
                this.each(function () {
                    var s = e(this);
                    s.data("daterangepicker") &&
                        s.data("daterangepicker").remove(),
